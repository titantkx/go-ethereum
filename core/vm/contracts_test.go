...
func testPrecompiled(addr string, test precompiledTest, t *testing.T) {
	...
	t.Run(fmt.Sprintf("%s-Gas=%d", test.Name, gas), func(t *testing.T) {
		if res, _, err := RunPrecompiledContract(p, common.HexToAddress(addr), nil, common.Address{}, AccountRef(common.Address{}), in, gas, nil, false, false); err != nil {
			t.Error(err)
...
func testPrecompiledOOG(addr string, test precompiledTest, t *testing.T) {
	...
	t.Run(fmt.Sprintf("%s-Gas=%d", test.Name, gas), func(t *testing.T) {
		_, _, err := RunPrecompiledContract(p, common.HexToAddress(addr), nil, common.Address{}, AccountRef(common.Address{}), in, gas, nil, false, false)
